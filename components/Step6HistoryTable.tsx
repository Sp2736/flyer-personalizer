...
export default function Step6HistoryTable() {
  ...
  return (
    <div className="w-full backdrop-blur-xl bg-white/5 border border-white/10 rounded-xl p-6 shadow-2xl space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-white/10">
        <div>
          ...
          <p className="text-xs text-slate-400">View past generated stickers and download full-res PDFs without extra credit charges</p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative flex-1 sm:w-64">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 focus:border-purple-500 rounded-lg pl-9 pr-3 py-2 text-xs text-white placeholder-slate-500 outline-none transition-all"
            />
          </div>
          ...
          <div className="relative">
            <input
              ...
              className="bg-white/5 border border-white/10 focus:border-purple-500 rounded-lg px-3 py-2 text-xs text-slate-300 outline-none transition-all"
            />
          </div>
          ...
          <div className="relative">
            <select
              ...
              className="bg-slate-900 border border-white/10 focus:border-purple-500 rounded-lg px-3 py-2 text-xs text-slate-300 outline-none transition-all"
            >
      ...
      <div className="overflow-x-auto rounded-lg border border-white/10">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-slate-900/80 text-[11px] font-bold uppercase tracking-wider text-slate-400 border-b border-white/10">
            ...
            {loading ? (
              ...
              history.map((item) => (
                <tr key={item.id} className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="py-3 px-4 text-slate-300">{item.school_name}</td>
                  ...
                  <td className="py-3 px-4 font-mono text-[11px] text-amber-300">{item.paper_size}</td>
                  <td className="py-3 px-4">
                  ...
                  <td className="py-3 px-4">
                    <div className="w-10 h-10 rounded border border-white/20 overflow-hidden bg-slate-800">
